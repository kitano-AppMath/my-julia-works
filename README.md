...
* <a href="">Bayesian Neural Network</a> : BNNをいくつかの方法で訓練し, 分類タスクを実験した. 
...
* <a href="https://github.com/kitano-AppMath/statistics/blob/main/Variational-Autoencoder.ipynb">Variational AutoEncoder</a>: 変分オートエンコーダを用いて簡単なクラスタリングを行った. 
